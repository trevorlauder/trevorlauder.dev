...
<div style="text-align:center; padding:1.25rem 0;">
	<img src="{{ '/assets/images/404-terminal.svg' | bust_file_cache }}" alt="Retro terminal 404 illustration" style="max-width:520px;width:100%;height:auto;margin:0 auto;display:block" loading="lazy" decoding="async" />
</div>
