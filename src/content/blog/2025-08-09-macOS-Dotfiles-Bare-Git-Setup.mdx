...
description: A detailed guide to managing a reproducible macOS development environment using a bare Git repository, custom aliases, and curated dotfiles for Zsh, WezTerm, Homebrew, and more. Includes setup, automation, and best practices for fast onboarding.
ogImage: /dotfiles.png
indexImage: /dotfiles.svg
featuredImage: /dotfiles-featured.svg
---

import Note from "../../components/Note.astro";

<Note>
  I have since moved to [chezmoi](https://www.chezmoi.io/). The [dotfiles
  repo](https://github.com/trevorlauder/dotfiles) reflects the current setup. I also use this in my
  [devcontainers](https://github.com/trevorlauder/devcontainers) setup.
</Note>
...
## Local overrides via `~/.dotfiles-local-settings`
...
Source it near the end of `~/.zshrc` (after exported defaults) so it can override any defaults:
